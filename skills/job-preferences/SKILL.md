...
Read `/Users/rukaiyakhan/Documents/Project/career-outreach-engine/claude-job-profile.json`. If the file doesn't exist yet, create it with an empty object `{}`.
...
Write the collected values into `/Users/rukaiyakhan/Documents/Project/career-outreach-engine/claude-job-profile.json` under the `preferences` key. Preserve all other existing keys in the file (like profile data used by `/job-apply`).
...
> **Preferences saved to `/Users/rukaiyakhan/Documents/Project/career-outreach-engine/claude-job-profile.json`.**
>
